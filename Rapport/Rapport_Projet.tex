...
Le \textbf{Bipartite Subgraph Problem} est un problème fondamental en algorithmique et en théorie des graphes. Il consiste à extraire, à partir d’un graphe général, un sous-graphe biparti optimisant un critère donné, le plus souvent le nombre d’arêtes conservées. Ce problème est intimement lié à la détection et à l'élimination des cycles impairs, qui caractérisent les graphes non bipartis.
...
\end{tikzpicture}
\caption{Représentation du graphe à 34 sommets}
\end{figure}
...
Comme attendu, la version naïve explore l'ensemble de l'espace des états, ce qui entraîne un nombre important de solutions et un coût computationnel élevé, particulièrement pour des graphes de cette taille. Cette observation justifie l'introduction de la version 66666améliorée avec heuristiques et élagages.
